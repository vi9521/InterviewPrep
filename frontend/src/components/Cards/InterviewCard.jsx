...
function InterviewCard({ interview, onSelect, onDelete }) {
    ...
    >
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <span className={`px-2 sm:px-3 py-1 rounded-full text-xs font-semibold border ${getExperienceColor(interview.experience)}`}>
      ...
      <div className="space-y-2 sm:space-y-3">
        <div className="flex items-start gap-2 sm:gap-3">
          ...
          <div>
            <p className="text-xs sm:text-sm font-medium text-gray-700 mb-0.5 sm:mb-1">Interview Type</p>
